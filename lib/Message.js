...
Message.commands = {
    ...
    SET_ALARM_SPEEDING              : 0x4105, // @todo: add function to tracker
    SET_ALARM_MOVEMENT              : 0x4106, // @todo: add function to tracker, add to parseCommandResult
    SET_ALARM_GEOFENCE              : 0x4302, // @todo: add function to tracker, add to parseCommandResult
...
Message.types = {
    ...
    REPORT_BY_TIME          : 0x00, // custom code, for integrity
