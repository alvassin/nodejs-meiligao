...
Message.commands = {
    ...
    GET_AUTHORIZED_PHONE            : 0x9003, // @todo: add to parseCommandResult
    ...
    SET_ALARM_MOVEMENT              : 0x4106, // @todo: add to parseCommandResult
    SET_ALARM_GEOFENCE              : 0x4302, // @todo: add to parseCommandResult
